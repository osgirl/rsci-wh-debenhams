...
class UserRolesController extends BaseController {
	...
	public function insertDataForm() {
		...
		$this->data['heading_title_insert'] = Lang::get('user_roles.heading_title_insert');
		
		$this->data['entry_role_name'] = Lang::get('user_roles.entry_role_name');
		$this->data['entry_permissions'] = Lang::get('user_roles.entry_permissions');
		
		$this->data['col_module'] = Lang::get('user_roles.col_module');
		$this->data['col_access'] = Lang::get('user_roles.col_access');
		$this->data['col_insert'] = Lang::get('user_roles.col_insert');
		$this->data['col_update'] = Lang::get('user_roles.col_update');
		$this->data['col_delete'] = Lang::get('user_roles.col_delete');
		$this->data['col_export'] = Lang::get('user_roles.col_export');
		$this->data['col_password'] = Lang::get('user_roles.col_password');
		$this->data['col_archive'] = Lang::get('user_roles.col_archive');
		$this->data['col_jda'] = Lang::get('user_roles.col_jda');
		$this->data['col_stock_piler'] = Lang::get('user_roles.col_stock_piler');
		$this->data['col_closed_po'] = Lang::get('user_roles.col_closed_po');
		$this->data['col_closed_so'] = Lang::get('user_roles.col_closed_so');
		$this->data['col_generate_letdown'] = Lang::get('user_roles.col_generate_letdown');
		
		$this->data['module_purchase_orders'] = Lang::get('user_roles.module_purchase_orders');
		$this->data['module_purchase_order_details'] = Lang::get('user_roles.module_purchase_order_details');
		$this->data['module_store_orders'] = Lang::get('user_roles.module_store_orders');
		$this->data['module_store_order_details'] = Lang::get('user_roles.module_store_order_details');
		$this->data['module_inventory'] = Lang::get('user_roles.module_inventory');
		$this->data['module_inventory_details'] = Lang::get('user_roles.module_inventory_details');
		$this->data['module_product_master_list'] = Lang::get('user_roles.module_product_master_list');
		$this->data['module_slot_master_list'] = Lang::get('user_roles.module_slot_master_list');
		$this->data['module_vendor_master_list'] = Lang::get('user_roles.module_vendor_master_list');
		$this->data['module_users'] = Lang::get('user_roles.module_users');
		$this->data['module_user_roles'] = Lang::get('user_roles.module_user_roles');
		$this->data['module_audit_trail'] = Lang::get('user_roles.module_audit_trail');
		$this->data['module_settings'] = Lang::get('user_roles.module_settings');
		$this->data['module_stock_piler'] = Lang::get('user_roles.module_stock_piler');
	...
	public function updateDataForm() {
		...
		$this->data['heading_title_update'] = Lang::get('user_roles.heading_title_update');
