...
class odbcConnection{
    ...
    {
      echo "cron/db2_connection: DRIVER=iSeries Access ODBC Driver;SYSTEM=172.16.1.9;DBQ={$this->jdaLib} \n";
      echo "Connecting to DB2... \n";
		$dsn_link = "DRIVER=iSeries Access ODBC Driver;SYSTEM=172.16.1.9;DBQ={$this->jdaLib}";
