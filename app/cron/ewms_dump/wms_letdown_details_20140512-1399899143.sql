...
CREATE TABLE `wms_letdown_details` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `letdown_details_store_or_sku_unique` (`store_or_sku`),
  UNIQUE KEY `letdown_details_move_doc_number_unique` (`move_doc_number`),
  UNIQUE KEY `letdown_details_from_slot_code_unique` (`from_slot_code`),
  UNIQUE KEY `letdown_details_store_code_unique` (`store_code`),
  UNIQUE KEY `letdown_details_so_no_unique` (`so_no`),
...
-- Dump completed on 2014-05-12 13:52:24
