...
CREATE TABLE `wms_purchase_order_lists` (
  ...
  `invoice_no` varchar(30) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
  `invoice_amount` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
  `delivery_date` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `datetime_done` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
