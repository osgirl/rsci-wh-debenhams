...
.contentasdfs th, .contentasdfs  td {border: solid 0px #F0F0F0; padding-right: 10px;  }
...
<div id="actionButtons">
	...
	<a href="{{$url_back}}">BACK TO SUBLOC LOAD LIST</a>
	...
	<section class="soContainer">
			...
			<tr>
				...
				<td>
					...
					<table>
					    ...
					    <td style="border: solid 0px #000;">  {{ Store::getStoreName($storelocation->from_store_code) }}
                           
					    </th></tr>   
						<tr><th style="text-align: right";>Destination :
					    <td   style="border: solid 0px #000;">  {{ Store::getStoreName($storelocation->to_store_code) }}</td>
					    </th></tr> 
		...
		<table class="contents">
			<tr>
				<th colspan="3" style="text-align: center"><h3> Pell number : {{$loadCode}}</h3></th>
			</tr>
				...
				<div >
                 <table class="contentasdfs" >
                 	...
                 	<tr  >
                 		...
                 		<th style="text-align: left;";> Tray</th>
                 	...
                 	<tr class="font-size-13 tblrow"  >
                 		...
                 		<td style="text-align: left;"><input    rows="2" cols="30">  </td>
                 		<td style="text-align: left;"><input  rows="2" cols="30">  </td>
