...
<div class="widget">
    ...
    <div class="widget-content">
    	{{ Form::open(array('url'=>'stocktransfer/assignedstockloadpost', 'id'=>"form-assign", 'class'=>'form-horizontal', 'style' => 'margin: 0px;', 'role'=>'form')) }}
            ...
            <div class="span3">&nbsp;</div>
                    ...
                    {{ Form::hidden('filter_assigned_to_user_id', $filter_assigned_to_user_id) }}
