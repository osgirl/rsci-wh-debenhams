...
<div class="widget">
    ...
    <div class="widget-content">
    	{{ Form::open(array('url'=>'user/updateData', 'class'=>'form-horizontal', 'id'=>'form-users', 'role'=>'form', 'method' => 'post')) }}
		<div class="span3">&nbsp;</div>
		<div class="span7">
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						{{ Form::text('firstname', $user->firstname, array('maxlength'=>'50')) }}
					</div> <!-- /controls -->
				</div> <!-- /control-group -->
				...
				<div class="control-group">
					...
					<div class="controls">
						{{ Form::text('lastname', $user->lastname, array('maxlength'=>'50')) }}
					</div> <!-- /controls -->
				</div> <!-- /control-group -->
