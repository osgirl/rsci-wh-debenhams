...
<div class="widget">
    <div class="widget-header"> <i class="icon-th-list"></i>
    	<h3>{{ $heading_title_assign_box }}</h3>
    </div>
    <!-- /widget-header -->

    <div class="widget-content">
    	{{ Form::open(array('url'=>'box/assign_to_piler', 'id'=>"form-assign", 'class'=>'form-horizontal', 'style' => 'margin: 0px;', 'role'=>'form')) }}

            <div class="span3">&nbsp;</div>
            		<div class="span7 add-piler-wrapper">
            			<div class="control-group">
            				<label class="control-label">{{ $entry_box_code }}</label>
            				<div class="controls">
