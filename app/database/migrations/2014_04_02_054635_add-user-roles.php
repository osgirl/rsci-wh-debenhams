...
class AddUserRoles extends Migration {
	...
	public function up()
	{
		...
		DB::table('user_roles')->insert(array(
			...
			'permissions' => '["CanAccessPurchaseOrders","CanExportPurchaseOrders","CanSyncPurchaseOrders","CanAssignPurchaseOrders","CanClosePurchaseOrders","CanAccessLetdown","CanExportLetdown","CanAccessPacking","CanExportPacking","CanAssignPacking","CanAccessBoxingLoading","CanExportBoxingLoading","CanAccessShipping","CanExportShipping","CanAccessStoreOrders","CanExportStoreOrders","CanSyncStoreOrders","CanCloseStoreOrders","CanAccessProductMasterList","CanExportProductMasterList","CanAccessStoreMasterList","CanExportStoreMasterList","CanAccessSlotMasterList","CanExportSlotMasterList","CanAccessVendorMasterList","CanExportVendorMasterList","CanAccessUnlisted","CanExportUnlisted","CanAccessExpiryItems","CanExportExpiryItems","CanAccessUsers","CanInsertUsers","CanUpdateUsers","CanDeleteUsers","CanExportUsers","CanChangePasswordUsers","CanAccessUserRoles","CanInsertUserRoles","CanUpdateUserRoles","CanDeleteUserRoles","CanAccessAuditTrail","CanExportAuditTrail","CanArchiveAuditTrail","CanAccessSettings","CanInsertSettings","CanUpdateSettings","CanDeleteSettings"]',
			'created_at' => date('Y-m-d H:i:s'),
			'updated_at' => date('Y-m-d H:i:s')
		));
		...
		/*DB::table('user_roles')->insert(array(
			'role_name' => 'doc_clerk',
			'permissions' => '["CanAccessUnlisted", "CanViewUnlisted", "CanExportUnlisted"]',
			'created_at' => date('Y-m-d H:i:s'),
			'updated_at' => date('Y-m-d H:i:s')
		));*/
	}
